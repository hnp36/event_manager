...
class Settings(BaseSettings):
    ...
    jwt_secret_key: str = Field(default="a_very_secret_key", description="Secret key for JWT")
    jwt_algorithm: str = Field(default="HS256", description="Algorithm used for JWT")
    refresh_token_expire_minutes: int = Field(default=1440, description="Expiration time for refresh tokens in minutes (24 hours)")
    ...
    smtp_username: str = Field(default='ccfa182face11a', description="Username for SMTP server")
    smtp_password: str = Field(default='abf930a4e1c3d1', description="Password for SMTP server")
